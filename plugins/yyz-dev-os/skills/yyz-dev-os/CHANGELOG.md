...
- Add public-directory candidate materials, review scenarios, and disclosure drafts for a Skills-only plugin submission.
...
- Add a private team Codex plugin marketplace and a deterministic Skill snapshot build/check workflow.

### Changed

- Keep the repository root as the canonical Skill source and publish the plugin Skill only as a verified generated snapshot.
